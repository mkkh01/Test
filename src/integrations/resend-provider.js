...
export class ResendProvider {
  ...
  async sendSampleEmail({ to, fullName = '', issue = '', previewUrl }) {
    ...
    const html = `<div style="font-family:Arial,sans-serif;line-height:1.6;color:#172033;max-width:640px;margin:auto"><h2>Client Payment &amp; Scope Protection Kit</h2><p>Hi ${name},</p><p>You mentioned: <strong>${safeIssue}</strong>.</p><p>We created practical templates to help freelancers and small agencies clarify scope, control revisions, organize payment terms, and document handover.</p><p>You can review samples from all three versions before deciding:</p><p><a href="${htmlPreviewUrl}" style="display:inline-block;background:#2463eb;color:#fff;padding:12px 18px;border-radius:8px;text-decoration:none">View the sample previews</a></p><p>Starter — 5 USDT<br>Complete — 7 USDT<br>Agency — 10 USDT</p><p>No pressure. The preview lets you see the format and level of detail first.</p><p>Best,<br>Client Protection Kit</p></div>`;
